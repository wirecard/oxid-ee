    ...
    public function getConfigFields()
    {
        ...
        $additionalFields = [
            'threeDMaid' => [
                ...
                'title' => Helper::translate('wdpg_config_three_d_merchant_account_id'),
                'description' => Helper::translate('wdpg_config_three_d_merchant_account_id_desc'),
            ],
            'threeDSecret' => [
                'type' => 'text',
                'field' => 'oxpayments__wdoxidee_three_d_secret',
                'title' => Helper::translate('wdpg_config_three_d_merchant_secret'),
                'description' => Helper::translate('wdpg_config_three_d_merchant_secret_desc'),
            ],
            'threeDMinLimit' => [
                'type' => 'text',
                'field' => 'oxpayments__wdoxidee_three_d_min_limit',
                'title' => Helper::translate('wdpg_config_three_d_min_limit'),
                'description' => Helper::translate('wdpg_config_three_d_min_limit_desc'),
            ],
            'nonThreeDMaxLimit' => [
                'type' => 'text',
                'field' => 'oxpayments__wdoxidee_non_three_d_max_limit',
                'title' => Helper::translate('wdpg_config_ssl_max_limit'),
                'description' => Helper::translate('wdpg_config_ssl_max_limit_desc'),
            ],
            'limitsCurrency' => [
                'type' => 'select',
                'field' => 'oxpayments__wdoxidee_limits_currency',
                'options' => $this->_getCurrencyOptions(),
                'title' => Helper::translate('wdpg_default_currency'),
            ],
            'moreInfo' => [
                'type' => 'link',
                'title' => Helper::translate('wdpg_more_info'),
                'link' => 'https://github.com/wirecard/oxid-ee/wiki/Credit-Card#non-3-d-secure-and-3-d-secure-limits',
                'text' => Helper::translate('wdpg_three_d_link_text')
            ],
            'descriptor' => [
                'type'        => 'select',
                'field'       => 'oxpayments__wdoxidee_descriptor',
                'options'     => [
                    '1'       => Helper::translate('wdpg_yes'),
                    '0'       => Helper::translate('wdpg_no'),
                ],
                'title'       => Helper::translate('wdpg_config_descriptor'),
                'description' => Helper::translate('wdpg_config_descriptor_desc'),
            ],
            'additionalInfo' => [
                'type'        => 'select',
                ...
                'title'       => Helper::translate('wdpg_config_additional_info'),
                'description' => Helper::translate('wdpg_config_additional_info_desc'),
            ],
            'deleteCanceledOrder' => [
                'type' => 'select',
                ...
                'title' => Helper::translate('wdpg_config_delete_cancel_order'),
                'description' => Helper::translate('wdpg_config_delete_cancel_order_desc'),
            ],
            'deleteFailedOrder' => [
                'type' => 'select',
                ...
                'title' => Helper::translate('wdpg_config_delete_failure_order'),
                'description' => Helper::translate('wdpg_config_delete_failure_order_desc'),
            ],
            'paymentAction' => [
                'type'        => 'select',
                'field'       => 'oxpayments__wdoxidee_transactionaction',
                'options'     => TransactionModel::getTranslatedActions(),
                'title'       => Helper::translate('wdpg_config_payment_action'),
                'description' => Helper::translate('wdpg_config_payment_action_desc'),
            ],
        ];
