...
class FormInteractionResponseFieldsTest extends OxidEsales\TestingLibrary\UnitTestCase
{
    ...
    {
        $response = new \Wirecard\Oxid\Model\FormInteractionResponseFields(self::URL, self::METHOD, $this->_oFormFields);
