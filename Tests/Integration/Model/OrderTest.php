...
class OrderTest extends Wirecard\Test\WdUnitTestCase
{
    ...
    {
        return [
            'order with foreign payment method: canceled' => ['2', WdOrder::IS_CANCELLED, false],
            'order with foreign payment method: failed' => ['2', WdOrder::IS_FAILED, false],
            'order to delete on canceled but not on failed: canceled' => ['1', WdOrder::IS_CANCELLED, true],
            'order to delete on canceled but not on failed: failed' => ['1', WdOrder::IS_FAILED, false],
            'order to delete on both canceled and failed: canceled' => ['3', WdOrder::IS_CANCELLED, true],
            'order to delete on both canceled and failed: failed' => ['3', WdOrder::IS_FAILED, true],
        ];
    }
}
