...
class Order extends Order_parent
{
    ...
    // what should happen if orders are cancelled or failed during the handling of the transaction
    const IS_CANCELLED = BackendService::TYPE_CANCELLED;
    ...
    private function _shouldBeDeletedOnState($sState)
    {
        ...
        return ($sState === self::IS_CANCELLED && $oPayment->oxpayments__wdoxidee_delete_canceled_order->value) ||
            ($sState === self::IS_FAILED && $oPayment->oxpayments__wdoxidee_delete_failed_order->value);
    }
}
