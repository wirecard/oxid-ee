 ...
 */
class WirecardOxid_Sniffs_NamingConventions_HungarianNotationVariableNameSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (in_array($variableName, self::RESERVED_VARIABLE_NAMES)) {
            return;
        }
